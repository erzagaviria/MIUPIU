...
const songs = {
  perfect: { url: "myAudio/Nuh... - Berdua Denganmu (Official Audio) - (320 Kbps).mp3", title: "Nuh... - Berdua Denganmu" },
  thousand: { url: "myAudio/Perunggu - Berhasil (Official Lyric Video) - (320 Kbps).mp3", title: "Perunggu - Berhasil" },
  allofme: { url: "myAudio/The Weeknd, JENNIE & Lily Rose Depp - One Of The Girls (Official Audio) - (320 Kbps).mp3", title: "The Weeknd, JENNIE & Lily Rose Depp - One Of The Girls" }
};
